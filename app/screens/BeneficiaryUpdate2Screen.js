...
function BeneficiaryUpdate2Screen(props) {
    ...
    return (
        <Screen style={styles.screen}>
            ...
            <TouchableOpacity activeOpacity={0.7} onPress={() => props.navigation.navigate("BeneficiaryUpdate1Screen")} style={{ position: 'absolute', top: RFPercentage(5), left: RFPercentage(3) }} >
                ...
                <View style={{ justifyContent: 'center', alignItems: 'center', width: '100%' }}>
                    ...
                    <View style={{ width: "100%", alignItems: "center", marginTop: RFPercentage(8) }}>
                        <MyAppButton
                            ...
                            onPress={() => props.navigation.navigate("BeneficiaryUpdate3Screen")}
...
export default BeneficiaryUpdate2Screen;