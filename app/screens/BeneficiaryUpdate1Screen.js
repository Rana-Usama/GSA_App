...
function BeneficiaryUpdate1Screen(props) {
                ...
                <View style={{ justifyContent: 'center', alignItems: 'center', width: '100%' }}>
                    ...
                    <View style={{ width: "100%", alignItems: "center", marginTop: RFPercentage(8) }}>
                        <MyAppButton
                            ...
                            onPress={() => props.navigation.navigate("BeneficiaryUpdate2Screen")}
...
export default BeneficiaryUpdate1Screen;