...
function PasswordRecovery2Screen(props) {
    ...
    return (
        <Screen style={styles.screen}>
            ...
            <View style={{ marginTop: RFPercentage(13), width: '85%', justifyContent: 'flex-end', alignItems: 'center', flexDirection: 'row', alignSelf: 'center' }} >
                <Text style={{ color: Colors.black, fontSize: RFPercentage(4), fontFamily: 'Comfortaa_400Regular' }} >
                    يرجى ادخال كلمة سر جديدة
                </Text>
            </View>
...
export default PasswordRecovery2Screen;